...
public class HasbeenAdapter extends BaseAdapter {
    ...
    public HasbeenAdapter(Context context) {
    ...
    @Override
    public int getCount() {
        return plantState.getHasPublishedList().size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //图片
        imageLoader.displayImage(plantState.getHasPublishedList().get(position).getHttpPic(), plantViewHolder.ivHasbeenItemPicture, plantState.getImageLoaderOptions(R.mipmap.not_loaded, R.mipmap.not_loaded, R.mipmap.not_loaded));
        //标题
        plantViewHolder.tvHasbeenItemTitle.setText(plantState.getHasPublishedList().get(position).getTitle());
        //更新时间
        plantViewHolder.tvHasbeenItemData.setText("最近更新时间 " + plantState.getHasPublishedList().get(position).getEditDate());
        return convertView;
    }
}
